...
(function(){var nav=document.getElementById('ug-mobile-nav');var btn=document.getElementById('ug-info-btn');var panel=document.getElementById('ug-info-panel');if(!nav||!btn)return;var t=null;new MutationObserver(function(){clearTimeout(t);if(nav.classList.contains('open')){btn.style.zIndex='1050';btn.style.opacity='0';if(panel)panel.style.opacity='0';}else{btn.style.opacity='1';if(panel)panel.style.opacity='1';t=setTimeout(function(){btn.style.zIndex='';},300);}}).observe(nav,{attributes:true,attributeFilter:['class']});})();
<\/script>`;
